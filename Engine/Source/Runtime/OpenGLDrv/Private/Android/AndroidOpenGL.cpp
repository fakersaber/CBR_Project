...
bool FAndroidOpenGL::SupportsSampleShading()
{
	PFNGLMINSAMPLESHADINGOESPROC glMinSampleShadingOES = (PFNGLMINSAMPLESHADINGOESPROC)((void*)eglGetProcAddress("glMinSampleShadingOES"));
	glEnable(GL_SAMPLE_SHADING_OES);
	glMinSampleShadingOES(1.f);
	return true;
}
...
void FAndroidOpenGL::ProcessExtensions(const FString& ExtensionsString)
{
	...
	if (bES31Support)
	{
		...
		//YJH Created By 2020/4/2 
		glTexStorage2DMultisample = (PFNGLTEXSTORAGE2DMULTISAMPLEPROC)((void*)eglGetProcAddress("glTexStorage2DMultisample"));
	}
